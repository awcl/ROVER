...
exports.seed = async function (knex) {
  ...
  await knex('member').insert([
    { id: 1, first_name: 'Santa', last_name: 'Claus', email: "s.claus1@email.com", rank: "SPC1", username: "bbb", password_hash: "$2b$12$hig73jSR/ccryE0pNivX7.SqN4DeovW1jXK7Drnq9QxxIKQgiTnA6",  organization_id: 1, admin: false, is_van_cert: true, is_sedan_cert: false, is_truck_cert: false, is_5_ton_cert: false, is_amrap_cert: false, is_hmmwv_cert: false,  is_mobilizer_cert: false,  is_patrol_cert: false, is_tank_cert: false, is_semitruck_cert: false, is_landrover_cert: false, is_forklift_cert: false},
