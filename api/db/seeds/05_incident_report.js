...
exports.seed = async function (knex) {
  ...
  await knex('incident_report').insert([
    ...
    { id: 2, incident_type: 'crash', incident_location: 'The Streets', incident_date: '2022-04-21', incident_time: '4:21', incident_description: 'I was doing fine, and then I wasnt', vehicle_id: 2, member_id: 2 }
  ]);
};