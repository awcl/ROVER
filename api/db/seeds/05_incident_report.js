...
exports.seed = async function(knex) {
  ...
  await knex('incident_report').insert([
    {id: 1, incident_type: 'ticket', incident_location: 'Vandenberg SFB', incident_date: '2022-05-26', incident_time: '9:30', incident_description: 'They were driving to slow and I was aggrivated', vehicle_id: 1, member_id: 1},
