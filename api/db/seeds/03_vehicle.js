...
exports.seed = async function (knex) {
  ...
  await knex('vehicle').insert([
    ...
    { id: 14, vehicle_type: 'sedan', miles: 62410, plate_number: 'G348989', description: '4 door full-size sedan', location: 'P67-12', organization_id: 1 },
    { id: 15, vehicle_type: 'sedan', miles: 40321, plate_number: 'G343679', description: '4 door full-size  electric vehicle', location: 'P67-13', organization_id: 1 },
    { id: 16, vehicle_type: 'truck', miles: 65430, plate_number: 'G3482', description: '4 door full-size size pickup', location: 'P61-12', organization_id: 1 }
  ]);
};